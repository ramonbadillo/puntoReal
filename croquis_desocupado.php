          ...
          <section class="wrapper">
			...
			<div class="col-sm-8">
				...
				<section class="panel">
                  ...
                  <form class="form-horizontal tasi-form" action="updateAsiento.php" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-lg-10">
                              <select name="puntos" class="form-control m-bot15">
		  						<?php 
		  							$puntos=Punto::all();
                      ...
                      <div class="form-group">
						  ...
						  <div class="col-md-3 col-xs-11">
						  <input name="estado" id="checkbox-03" value="1" type="checkbox" /> Pagado</label>
						  </div>
					  </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-lg-5">
                              <div class="input-group m-bot15">
                                  ...
                                  <input name="dollares" type="text" class="form-control">
                                  <span class="input-group-addon">.00</span>
                              </div>

                              <div class="input-group m-bot15">
                                  <span class="input-group-addon">MX $</span>
                                  <input name="pesos" type="text" class="form-control">
                                  <span class="input-group-addon">.00</span>
                              </div>
                          </div>
                      </div>
