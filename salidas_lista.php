              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  ...
						  <li class="active"><a  href="salidas_lista.php"><i class="icon-eye-open"></i>Ver Todas</a></li>
						  <?
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              <thead>
                              <tr>
								  <th><i class=" icon-edit"></i> Fecha(d/m/a)</th>
                                  <th><i class="icon-bullhorn"></i> Origen</th>
								  <th><i class="icon-bullhorn"></i> Destino</th>
								  <th><i class="icon-bullhorn"></i> Asientos</th>
								  <th><i class=" icon-edit"></i> Ver</th>
                              </tr>
                              </thead>
                              <tbody>
  							...
  							$salidasTodas=Salida::find("all");
							$times = count($salidasTodas);	
							  
							  for($i=0;$i<$times;$i++){
	    						$porcentaje=$salidasTodas[$i]->num_asientos/$salidasTodas[$i]->max;
	    						$porcentaje=$porcentaje*100;
                                echo '<tr>';
  								
  								echo  '<td>'.$salidasTodas[$i]->fecha->format('d/m/Y').'</td>';
								echo  '<td>'.$salidasTodas[$i]->origen.'</td>';
  								echo  '<td>'.$salidasTodas[$i]->destino.'</td>';
  								
  								echo  '<td>
  									  '.$salidasTodas[$i]->num_asientos.'/'.$salidasTodas[$i]->max.'
  		                                <div class="progress progress-xs">
										  
  		                                  <div class="progress-bar" role="progressbar" aria-valuenow="'.$salidasTodas[$i]->num_asientos.'" aria-valuemin="0" aria-valuemax="'.$salidasTodas[$i]->max.'" style="width: '.$porcentaje.'%;">
  								  ...
  								  ';
								  echo  '<td><a href="croquis.php?id='.$salidasTodas[$i]->id.'"><span class="label label-success label-mini">Más detalles</span></td>';
                                  echo  '</tr>';
