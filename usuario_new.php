          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  <li class="active"><a  href="usuario_new.php"><i class="icon-plus"></i>Agregar</a></li>
                ...
                <div class="col-lg-6">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" action="createUsuario.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="passwd" class="form-control" placeholder="Contrasenia">
                                </div>
                                <div class="form-group">
		                        ...
		                        <div class="form-group">
		                            <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">Tipo de Usuario</label>
		                            <div class="col-lg-10">
		                                <select name="tipo" class="form-control m-bot15">
		  		  						  <option id="normal" value="Admin">Normal</option>
