              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active" ><a  href="punto_lista.php"><i class="icon-eye-open"></i>Ver Todos</a></li>
                      </ul>
                  </li>
                  ...
                  <div class="col-lg-6">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
  							...
  							$puntoTodos=Punto::find("all");
							$times = count($puntoTodos);	
							  
							  for($i=0;$i<$times;$i++){
                                echo '<tr>';
  								
  								echo  '<td>'.$puntoTodos[$i]->nombre.'</td>';
